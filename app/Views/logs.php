        ...
        <div class="col-sm-3 col-md-2 sidebar">
            ...
            <div class="list-group">
                <?php foreach($files as $file):?>
                    ...
                    ?>
                        <?php echo sprintf('<a class="list-group-item %s"  href="%s?file=%s">%s</a>', $active, url('logger'),$file,$file);?>
                <?php endforeach;?>
            </div>
        </div>
                ...
                <?php foreach($logs as $log):?>
                    <tr>
                        <td class="text-<?php echo $log->type->class;?>">
                            <span class="glyphicon glyphicon-<?php echo $log->type->icon;?>-sign" aria-hidden="true"></span>
